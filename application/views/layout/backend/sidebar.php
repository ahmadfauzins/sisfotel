	...
	<aside id="sidebar-wrapper">
		...
		<?php } elseif ($this->session->userdata('role') === '2') { ?>
			<ul class="sidebar-menu">
				...
				<li class="menu-header">Master Data</li>
				<li><a class="nav-link" href="<?= base_url('a/akun')?>"><i class="fas fa-envelope"></i> <span>Data Akun</span></a></li>
				<li><a class="nav-link" href="<?= base_url('a/akun/pending')?>"><i class="fa fa-clock"></i> <span>Data Akun (Pending)</span></a></li>
				<li><a class="nav-link" href="<?= base_url('a/pengajuan')?>"><i class="fas fa-comment-dots"></i> <span>Data Pengajuan</span></a></li>
				<li><a class="nav-link" href="<?= base_url('a/keuangan')?>"><i class="fas fa-money-bill-wave"></i> <span>Data Rekomendasi</span></a></li>
				<li><a class="nav-link" href="<?= base_url('a/berita')?>"><i class="fas fa-file-signature"></i> <span>Data Menara</span></a></li>
				<li><a class="nav-link" href="<?= base_url('a/berita')?>"><i class="fas fa-file-signature"></i> <span>Data Petugas</span></a></li>
				<li><a class="nav-link" href="<?= base_url('a/berita')?>"><i class="fas fa-file-signature"></i> <span>Data Pemohon</span></a></li>
...
<!-- 
		...
		<?php } elseif ($this->session->userdata('role') === '3') { ?>
			<ul class="sidebar-menu">
				...
				<li class="menu-header">Master Data</li>
				<li><a class="nav-link" href="<?= base_url('j/berita') ?>"><i class="fas fa-file-signature"></i> <span>Permohonan Registrasi</span></a></li>
				<li><a class="nav-link" href="<?= base_url('j/berita') ?>"><i class="fas fa-file-signature"></i> <span>Pengajuan Data</span></a></li>
